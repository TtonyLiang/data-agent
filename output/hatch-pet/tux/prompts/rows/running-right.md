Create one horizontal animation strip for Codex pet `tux`, state `running-right`.
...
Identity: same pet in every frame: A black-and-white tuxedo cat with a white chest patch, white paws, bright yellow-green eyes, and a cozy domestic personality.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
