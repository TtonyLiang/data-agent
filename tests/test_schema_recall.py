        ...
        return [
            {
                ...
                "columns": [
                    ...
                    {"column_name": "balance", "column_comment": "贷款余额", "data_type": "decimal"},
                ],
            },
            {
                ...
                "columns": [
                    ...
                    {"column_name": "application_id", "column_comment": "申请编号", "data_type": "bigint"},
                ],
            },
            {
                ...
                "table_comment": "放款指标表",
                "columns": [
                    {"column_name": "loan_amount", "column_comment": "放款金额", "data_type": "decimal"},
                ],
            },
        ]
...
async def test_schema_recall_matches_question_and_semantic_terms(monkeypatch):
    ...
    result = await schema_recall.schema_recall_node({
        ...
        "semantic_runtime": {
            "metrics": [
                {"metric_key": "outstanding_balance", "name": "余额", "base_table": "loan_account_indicator", "dimensions": ["region"]},
                {"metric_key": "application_count", "name": "申请笔数", "base_table": "loan_application_indicator", "dimensions": ["application_region"]},
            ],
            "mappings": [
                {"asset_key": "region", "name": "区域", "table_name": "loan_account_indicator", "column_name": "region"},
                {"asset_key": "application_region", "name": "申请区域", "table_name": "loan_application_indicator", "column_name": "region"},
            ],
        },
        "runtime_evidence": [],
    })
...
def test_nl2sql_schema_context_uses_recalled_tables_first():
    schema = [
        {"table_name": "orders", "table_comment": "订单表", "columns": [{"column_name": "amount", "data_type": "decimal", "column_comment": "金额"}]},
        {"table_name": "customers", "table_comment": "客户表", "columns": [{"column_name": "name", "data_type": "varchar", "column_comment": "姓名"}]},
    ]
